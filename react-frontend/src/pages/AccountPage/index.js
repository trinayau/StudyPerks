const AccountPage = () => {
    return ( <div className="accountPage">
            <div class="user">
        <div class="avatar">
            <img src="images\icons8-cat-profile-80.png"/>
        </div>
        <div class="userinfo">
            <h3>Username</h3>
...
<div class="features">
    <div class="section">
        <div class="col-4 data">
            <div class="icon"><img src="images\icons8-timer-64.png"/></div>
            <div class="stats">
                <p>Today</p>
        ...
        <div class="col-4 data">
            <div class="icon"><img src="images\icons8-fire-94.png"/></div>
            <div class="stats">
                <p>Study Streak</p>
                <p class="stat">3</p>
            </div>
        ...
        <div class="col-4 data">
            <div class="icon"><img src="images\icons8-ranking-64.png"/></div>
            <div class="stats">
                <p>Ranking</p>
                <p class="stat">#17</p>
            </div>
